...
public final class GillyCarpetAddonsServerTest {
    ...
    /**
     * Tests that the onGameStarted method runs without throwing an exception.
     * This ensures the settings have been parsed okay.
     * We call the method in CarpetServer to ensure everything is set up okay
     */
    @Test
